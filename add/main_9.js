...
for (const item of usersList) {
    ...
    divStreet.innerText = `${item.address.street}`
    divAddress.append(divStreet)

    let divSuite = document.createElement('div');
    divSuite.innerText = `${item.address.suite}`
    divAddress.append(divSuite)

    let divCity = document.createElement('div');
    divCity.innerText = `${item.address.city}`
    divAddress.append(divCity)

    let divZipcode = document.createElement('div');
    divZipcode.innerText = `${item.address.zipcode}`
    divAddress.append(divZipcode)

    let divGeo = document.createElement('div');
    divAddress.append(divGeo)

    let divLat = document.createElement('div');
    divLat.innerText = `${item.address.geo.lat}`
    divGeo.append(divLat)

    let divLng = document.createElement('div');
    divLng.innerText = `${item.address.geo.lng}`
    divGeo.append(divLng)

    let divPhone = document.createElement('div');
    divPhone.innerText = `${item.phone}`
    div.append(divPhone)

    let divWebsite = document.createElement('div');
    divWebsite.innerText = `${item.website}`
    div.append(divWebsite)

    let divCompany = document.createElement('div');
    div.append(divCompany)

    let divNameCompany = document.createElement('div');
    divNameCompany.innerText = `${item.company.name}`
    divCompany.append(divNameCompany)

    let divaCtchPhrase = document.createElement('div');
    divaCtchPhrase.innerText = `${item.company.catchPhrase}`
    divCompany.append(divaCtchPhrase)

    let divBs = document.createElement('div');
    divBs.innerText = `${item.company.bs}`
    divCompany.append(divBs)
}
